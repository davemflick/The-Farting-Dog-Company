    ...
    return(
      <nav className="navbar navbar-default navbar-fixed-top">
        <div className="navbar-header"> 
          <a className="navbar-brand" href="#"><img className="navLogo" alt="brand" src="./app/static/images/logo1.png" /><strong className="companyName">The Farting Dog Company</strong></a>
